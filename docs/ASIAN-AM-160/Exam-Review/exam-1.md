...
3. Draw on two historical examples to explain why it was so difficult for workers to organize across racial and ethnic lines. [5 points each example, 10 points total] Draw on one historical example to show how some workers organized along class lines to fight for better pay and working conditions. [5 points]
    ...
    ??? success "Key Ideas"
        ...
        2. **One Historical Example of Workers Organizing Along Class Lines**
            1. **The Japanese and Filipino Sugar Plantation Strike:** Despite the ethnic divisions on Hawaiian plantations, some workers did manage to organize along class lines to fight for better pay and conditions. In 1920, Japanese (Hawaii Federation of Japanese Labor) and Filipino workers (Filipino Labor Union) on the sugar plantations put aside their ethnic differences and united in a strike (Oahu sugar strike of 1920), demanding higher wages and better working conditions. This cross-ethnic labor action marked a significant moment of class-based solidarity, as the workers recognized their shared exploitation by plantation owners and came together to challenge their poor treatment (Ronald Takaki, “Raising Cane: The World of Plantation Hawai’i,” Strangers From a Different Shore, 1990).
...
5. Discuss and detail three ways in which the 1907-8 Gentlemen’s Agreement differed from Chinese exclusion. [5 points each way, 15 points total]
    ...
    ??? success "Key Ideas"
        ...
        1. **Three Ways the 1907-8 Gentlemen’s Agreement Differed from Chinese Exclusion**
            ...
            3. **Economic Background and Treatment:** The Chinese Exclusion Act of 1882 was passed during an economic recession, where Chinese laborers were scapegoated as competitors for jobs, leading to harsh exclusionary policies. In contrast, by the time of the Gentlemen’s Agreement in 1907-1908, Japanese immigrants were seen as too successful, especially in agriculture, where they competed with white farmers. This economic success led to resentment, but instead of outright exclusion, the U.S. negotiated limits on Japanese immigration. Thus, while Chinese exclusion was driven by fears of job competition during hard times, Japanese immigration was restricted due to their economic achievements.
...
9. Not including the 1882 Chinese Exclusion Act, discuss and detail three immigration policies that contributed to the construction of Asian Americans as “undesirable aliens.” [5 points each policy, 15 points total]
    ...
    ??? success "Key Ideas"
        ...
        3. **The Page Act of 1875**
           The Page Act of 1875 was one of the earliest laws targeting Asian immigration, particularly focusing on Chinese women. It was framed as a means of preventing "undesirable" immigrants, specifically Chinese women, from entering the U.S. under the suspicion that they were being brought for prostitution. The act effectively restricted the immigration of Chinese women, reinforcing stereotypes that portrayed them as morally corrupt and unworthy of entering the country. This law laid the foundation for constructing Chinese immigrants—and by extension, Asian immigrants in general—as undesirable, particularly by painting them as immoral influences. (Source: Eithne Luibheid, Entry Denied, 2002).
   ...
   for the Equality of Manhood"
    ...
    ??? success "Key Ideas"
        ...
        2. **Three Reasons the Chinese Equal Rights League Provided Against the Renewal of the Chinese Exclusion Act**
            ...
            2. **Contributions of Chinese Immigrants to American Society**
            ...
            3. **Inhumane and Discriminatory Nature of the Geary Act**

                1. **Reason:** The League condemned the 1892 Geary Act for its discriminatory and inhumane provisions, particularly the requirement for Chinese immigrants to carry identification papers at all times or face deportation. This law essentially reversed the legal principle of "innocent until proven guilty" by placing the burden of proof on Chinese immigrants to demonstrate their legal status. If a Chinese person was found without their identification papers, they were presumed to be in the country illegally unless they could prove otherwise, a standard that no other immigrant group was subjected to. This created a system that criminalized the daily existence of Chinese immigrants, treating them as inherently suspicious.
                2. **Significance:** This argument was significant because it highlighted the racial injustice embedded in the law. The Geary Act essentially treated Chinese immigrants as guilty until proven innocent, a stark departure from the legal protections afforded to other residents of the United States. The League's emphasis on this violation of fundamental legal rights sought to reveal the hypocrisy of the law and evoke sympathy by showcasing the undue hardship it inflicted on Chinese immigrants and their families. This further underscored the racial discrimination that Chinese immigrants faced under U.S. immigration policies.
    ...
    ??? success "Key Ideas"
        ...
        1. **Four Reasons Exclusionists Used to Justify Banning Hindus from the United States and Ram Chandra's Arguments Against Them**
            1. **Undesirability of Hindu Immigrants**
                1. **Exclusionist Reason:** Exclusionists claimed that Hindus were undesirable immigrants, alleging that they were unable to contribute positively to American society and posed a threat to the moral and social fabric of the country.
                2. **Chandra's Argument:** Ram Chandra strongly refuted this, arguing that Hindus were "law-abiding and faithful workers" who had not been involved in criminal activities or social disturbances. He pointed out that Hindus did not "insult the women of the country," did not beg in the streets, and had never been a public charge, in contrast to certain European immigrants who filled "prisons, saloons, and low quarters". By highlighting these points, Chandra presented Hindus as more desirable than some European immigrants, countering the idea that they were undesirable.
            2. **Inability to Assimilate**
                1. **Exclusionist Reason:** Another common argument was that Hindus could not be assimilated into American society and would remain a distinct and foreign population incapable of becoming "Americanized."
                2. **Chandra's Argument:** Chandra argued that this fear of Hindus being unable to assimilate was baseless. He asserted that Hindu immigrants who received American education were indistinguishable from other Americans, except for their skin color. He emphasized that "education is the solution of the problem of assimilation" and that Hindus, when given the opportunity, could fully integrate into American life​(PD #2 - Exclusion of Hi…). Chandra’s argument stressed that cultural and social assimilation was not an issue, and the real concern lay in racial prejudice.
            3. **Economic Threat**
                1. **Exclusionist Reason:** Exclusionists claimed that Hindu immigrants would overwhelm the labor market and take jobs away from American workers, thereby threatening the economic stability of the working class.
                2. **Chandra's Argument:** Chandra countered this by pointing out that the small number of Hindu immigrants who came to the U.S. did not pose a significant economic threat. He stated that Hindus were too poor to come to America in vast numbers and were primarily motivated by escaping "unspeakable poverty under British rule" to seek better opportunities". Chandra emphasized that Hindu immigration did not significantly impact the American labor market and that the economic concerns were exaggerated.
            4. **Racial and Color Prejudice**
                1. **Exclusionist Reason:** Exclusionists often cited race and color as reasons to exclude Hindus, implying that their darker skin made them inferior and unsuitable for American society.
                2. **Chandra's Argument:** Chandra responded to this argument by dismissing the relevance of skin color, pointing out that Hindus had "the same color as the Spaniards, Mexicans, or Southern Italians." He argued that under the skin, "all look alike" according to physicians, emphasizing that race and color should not be used as a basis for discrimination. Chandra's argument attacked the superficial basis of racial prejudice and sought to demonstrate that such arguments were rooted in ignorance and bias.
        2. **The Real Reason Behind the Exclusion of Hindus from the United States**

            According to Ram Chandra, the real reason behind the exclusion of Hindus from the United States was British influence. Chandra argued that the British government did not want Hindus to come to America because they feared that immigrants from India might "become imbued with pestiferous ideas of political freedom". The British government did not want Hindus to be exposed to democratic ideals, which could fuel the Indian independence movement. Therefore, the British actively lobbied for the exclusion of Hindus, portraying them as undesirable to prevent them from gaining support for India's struggle for independence.

        3. **Significance of the Real Reason**

            The significance of Chandra’s argument lies in its exposure of the geopolitical motives behind immigration exclusion. While the public reasons for exclusion were framed in terms of economics, morality, and assimilation, Chandra reveals that the true motivation was the British desire to maintain control over India by preventing the spread of revolutionary ideas among the Indian population. This sheds light on how immigration policies were influenced not only by domestic concerns but also by international politics and colonial interests. Chandra’s argument also highlights the intersection of imperialism and racial exclusion, showing that immigration laws were used as a tool to suppress anti-colonial movements and limit the political freedom of colonized peoples.
...
3. Primary Document #3 – "Benevolent Assimilation Proclamation"
    ...
    ??? success "Key Ideas"
        ...
        1. **What is the policy of "Benevolent Assimilation"?**
            ...
            The document describes "benevolent assimilation" as a mission to offer "the blessings of good and stable government" under American rule, supposedly ensuring justice and individual rights to the Filipinos while repressing resistance and maintaining strong military authority.
